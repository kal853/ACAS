rem---------------------------------------------------------
rem	SET UP DMS SCREEN EQUATES    FPYDED - 18-NOV-79|6PM
...
data		   \
	  ...
	  19,7,28,0,4,\       rem   O fld #6
	  19,8,38,0,4,\       rem   O fld #7
	  19,9,44,0,4,\       rem   O fld #8
	  28,13,27,0,4
	  rem	O fld #9
crt.data$(6)="1.  STANDARD DEDUCTION RATES"
crt.data$(7)="2.  FEDERAL WITHOLDING TAX TABLE ENTRY"
crt.data$(8)="3.  SYSTEM EARNING AND DEDUCTION INFORMATION"
