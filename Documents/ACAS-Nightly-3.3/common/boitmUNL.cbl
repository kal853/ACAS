...
*>**
*>   Security.           Copyright (C) 2016 - 2026 & later, Vincent Bryan Coen.
*>                       Distributed under the GNU General Public License.
*>                       See the file COPYING for details.
*>**
*>   Written.            28 September 2025.
*>**
*>   Remarks.            This module only uses the BO Item file.
*>
...
*>**
*>   Changes.
*> 31/05/23 vbc - .00 boitmUNL Source taken from analUNL and vers reset.
*> 16/04/24 vbc       Copyright notice update superceding all previous notices.
*> 19/09/25 vbc - 3.3.00 Version update and builds reset.
*> 15/10/25 vbc - 3.3.01 Updated error and test after write to match *RES progs.
*>**
*>
*>*************************************************************************
*>
...
*>
 copy "selboitm.cob".
     select  BOitm-File-Seq  assign        "bostkitm.seq"  *> O/P
...
*>----------------------
 77  prog-name           pic x(20)    value "boitmUNL (3.3.01)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(38) value "SY003 Problem reading BoStkItm file = ".
...
*>
     ...
     string   Prog-Name " Cobol files in use " into SO-Print.
     perform  Call-Sysout.
*>
...
*>
     ...
     if       FS-Reply not = zeros
              move     "No bostkitm file to process" to SO-Print
              perform  Call-Sysout
...
*>
 aa010-Read-Recs.
     perform  forever
              ...
              write    WS-BO-Stk-Itm-Record from BO-Stk-Itm-Record
              if       FS-Reply not = zero
                       move     spaces to SO-Print
                       string   SY006
                                FS-Reply into SO-Print
                       perform  Call-Sysout
                       display  SO-Print at 0701 with erase eol foreground-colour 2
                       exit perform
              end-if
