...
*>**
*>   Security.           Copyright (C) 2016 & 2026 and later, Vincent Bryan Coen.
...
*>----------------------
 77  prog-name           pic x(24)    value "valueUNL (3.3.01)".
...
*>
 01  Error-Messages.
     03  SY003          pic x(35) value "SY003 Problem reading value file = ".
     03  SY006          pic x(33) value "SY006 Write error on .seq file = ".
