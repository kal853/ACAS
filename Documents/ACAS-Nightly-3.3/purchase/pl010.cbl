...
*> 05/09/25 vbc - .18 In validate-address chg to support 5 delimiters in address.
*>                    WARNING - This may present problems else where.
...
*>----------------------
 77  prog-name           pic x(15) value "PL010 (3.3.00)".
