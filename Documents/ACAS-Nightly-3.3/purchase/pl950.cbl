...
*>                                                    *
*>         This program can be used in place of PL940 *
*>          Cheque writer.                            *
*>       It wil create a listing of payments with :   *
*>   sort code/ account, amounts etc                  *
*>     This can be provided to your bankers for B2B   *
*>       payments                                     *
*>                                                    *
*>*****************************************************
*>
...
*>----------------------
 77  prog-name           pic x(15) value "PL950 (3.3.00)".
