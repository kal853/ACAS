...
*>****************************************************************
*>               ????????????????????                  *
*> from py900 NOT YET CODED. So what is it for ????
*>
*>****************************************************************
*>
...
*>**
*>    Remarks.          Employee Ded/Earn & Cost Ded.
*>                      Semi-sourced from Basic code from empdent.
*>**
...
*>-----------------------
 77  prog-name               pic x(15) value "PY900 (1.0.01)".  *> First release pre testing.
*>
 copy "wsmaps03.cob".
 copy "wsfnctn.cob".
