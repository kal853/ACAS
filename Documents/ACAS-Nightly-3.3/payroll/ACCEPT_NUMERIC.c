 ...
 * Version = 1.05
 * Dated  = 2024/03/13
 * Author = Chuck H. Copyright for use with GnuCobol only.
 * Updated = Vincent B. Coen -
 *          2025-10-19         Make UC remarks on 1st word.
 *                             Ensure called name is uppercase
 *                             to match GC standards for internal code.
 * version now 1.05 from 1.04
 */
