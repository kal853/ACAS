...
*>
*>  NOT yet any coding as src from other program. <<<<<<<<<<<<<
*>  17/01/26
*>****************************************************************
*>
...
*>**
*>    Remarks.          Employee Rate Table Maintenance.
*>                      Semi-sourced from Basic code from ratent.
*>                      CODE from py900 NO CODING CHANGES MADE YET as this
*>                      program will be used for something else possibly.
*>**
...
*>-----------------------
 77  prog-name               pic x(15) value "PY900 (1.0.02)".  *> First release pre testing.
*>
 copy "wsmaps03.cob".
 copy "wsfnctn.cob".
*> copy "wsledger.cob".  *> GL
*> copy "irswsnl.cob" replacing NL-Record by WS-IRSNL-Record.
*>
 copy "Test-Data-Flags.cob".  *> set sw-Testing to zero to stop logging.
*>
*> REMARK OUT ANY IN USE       ??????????   needed ?
*>
...
*>
 01  Dummies-For-Unused-FH-Calls.      *> IRS call blk at ab000-ACAS-IRS-Calls
...
*>
         ...
         88  WS-Dollar                    value "$".
*>
     03  WS-Active-Mode      pic x        value space.  *> Are we in Input or Amend mode etc.
     03  WS-Agency           pic 9        value 0.   *> NOT USED YET but in CB.
*>
*>  THIS IS A REMINDER FOR ME only as NOT USED YET.
*>
*>
...
*>
 01  SS-Param-1-Company-Details-1 background-color cob-color-black
     ...
     03  value "---------------------------------------------------------------------------"
                                     line 19 col  1.
     03  value "Lines Per Page  ["   line 20 col  1.
     03  value "]    Debugging Aid ["        col 20.
     03  value "] {N or Y}"                  col 41.
 ...
 *>    03  using PY-PR1-Page-Lines pic 99       line 20 col 18 foreground-color 3.
 *>    03  using PY-PR1-Debugging  pic x        line 20 col 40 foreground-color 3.
*>
 ...
 *>                             pic 99/99/9999 col 61 foreground-color 3.
     03  value "] |"                         col 71.
 ...
 *>    03  using PY-PR1-S-Used  pic x  line  8 col 21 foreground-color 3.
     03  value "] End of Last Semi-Monthly Pay Period ["
                                             col 22.
 *>    03  using PY-PR2-Last-Day-Last-S pic 99/99/9999 line 08 col 61 foreground-color 3.
     03  value "] |"                         col 71.
     03  value "    | Biweekly     ["
                                     line  9 col  1.
 *>    03  using PY-PR1-B-Used  pic x     line 09 col 21 foreground-color 3.
     03  value "] End of Last Biweekly Pay Period     ["
                                             col 22.
 *>    03  using PY-PR2-Last-Day-Last-B pic 99/99/9999 line  9 col 61 foreground-color 3.
     03  value "] |"                         col 71.
     03  value "    | Weekly       ["
                                     line 10 col  1.
 *>    03  using PY-PR1-W-Used  pic x  line 10 col 21 foreground-color 3.
     03  value "] End of Last Weekly Pay Period       ["
                                             col 22.
 *>    03  using PY-PR2-Last-Day-Last-W pic 99/99/9999 col 61 foreground-color 3.
...
*>YOUR COMPANY NAME                                                   00/00/ccyy
*>                                Payroll System
*>                          Employee Earn/Ded and Cost
*>
*> Empl No. [       ]  Name {                                } SSN {            }
*> ------------------------------------------------------------------------------
*>    ----- Cost Distribution -----    |    ------- Exemptions From -------
*>          of Employee Gross          |            Tax Witholding
...
*> Empl No [       ]   Name                                SSN
*>-----------------------------------+---------------------------------------
*>   Pay Interval  And  Pay Rates    |           Tax  Witholding
...
*>rate1 Desc. Name  Rate [999999.99] |          State    Wh  Allowances  [  ]
...
*>   Vacation	Rate     [         ] Accumulated [999999.99] Used [999999.99]
...
*>Overpayment From Previous Quarter...........................[99999999.99]
...
*>YOUR COMPANY NAME                                                   00/00/ccyy
*>                               Payroll System
*>                         Update Company Liabilities
*>
*>                  Company Liabilities (Not Totalled from History)
*>                               Quarter to Date
*>         FICA:[            ] FUTA:[            ] SUI:[            ]
*>                                 Year to Date
*>         FICA:[            ] FUTA:[            ] SUI:[            ]
*>
*>                        Quarter to Date (Not Totalled)
*>                                      Earned              Taken
*>              Vacation Time:      [            ]     [            ]
*>              Sick Leave:         [            ]     [            ]
*>              Comp Time:          [            ]     [            ]
*>
*>                  Year to Date (Totalled from Employee Records)
*>                                      Earned              Taken
*>              Vacation Time:      [            ]     [            ]
*>              Sick Leave:         [            ]     [            ]
*>              Comp Time:          [            ]     [            ]
 ...
 *>             display  Display-Heads
   ...
   *>           accept   SS-Param-1-Company-Details-1 *> UPDATE
              ...
              accept   PY-PR1-Page-Lines        at 2018 foreground-color 3 UPDATE
              accept   PY-PR1-Debugging         at 2040 foreground-color 3 UPDATE UPPER

              move     UPPER-CASE (PY-PR1-Debugging) to PY-PR1-Debugging
              if       PY-PR1-Debugging not = "N" and not = "Y"
                       move     PY103 to WS-Err-Msg
                       perform  aa100-Bad-Data-Display
                       go to    aa011-Retry-1
              end-if
              move     UPPER-CASE (PY-PR1-Dflt-Pay-Interval) to PY-PR1-Dflt-Pay-Interval
...
*>
     ...
     move     Suser         to PY-PR1-Co-Name
                               PY-PR1-Trade-Name.  *> Can be overwritten
     ...
     if       Post-Code (1:4) not = spaces
              move     Post-Code to PY-PR1-Co-Post-Code.  *> It concains State & ZIP
...
*> Default as this is for the USA and may be Canada
     ...
     move     Page-Lines    to PY-PR1-Page-Lines.
     ...
     move     "N"           to PY-PR1-S-Used
                               ...
                               PY-PR2-941-Printed
                               PY-PR2-W2-Printed.
     move     "Y"           to PY-PR1-Check-Printing-Used
                               PY-PR1-M-Used
                               PY-PR1-IRS-Used
...
*>
     ...
     if       Date-Form =  2 *> USA
              ...
              move     WSE-Month
                            to PY-PR2-Last-Day-Last-W (1:2)
              move     WSE-Days
                            to PY-PR2-Last-Day-Last-W (3:2)
     else
              ...
              move     WSE-Days
                            to PY-PR2-Last-Day-Last-W (1:2).
     move     WSE-Year      to PY-PR2-Last-Day-Last-W (5:4).
*>
     move     PY-PR2-Last-Day-Last-W  to    *> stored as ddmmccyy or mmddccyy
...
*>
     move     Print-Spool-Name  to PY-PR1-Print-Spool-Name.
     move     Print-Spool-Name2 to PY-PR1-Print-Spool-Name2.
     move     Print-Spool-Name3 to PY-PR1-Print-Spool-Name3.
...
*>   from (1)  IRS [ not set up for GL i.e., not coding ]
*>
...
*>
     go to    ab020-Exit.   *> JIC more code here
*>
...
*>
*> Other presets for allowances from dedend.bas but possibly Out Of Date
